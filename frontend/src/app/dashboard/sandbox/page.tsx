...
export default function SandboxPage() {
  ...
  const runResearch = async () => {
    ...
    try {
      ...
      setError(getErrorMessage(err, 'An error occurred during research'));
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-semibold tracking-tight text-white sm:text-3xl">AI Research Sandbox</h1>
        <p className="mt-2 text-sm text-gray-400">Test the &quot;Research-before-reach&quot; agent on any company domain.</p>
      </div>
      ...
      <div className="min-h-[400px]">
        {isLoading && (
          <div className="flex flex-col items-center justify-center py-20 text-gray-400">
            ...
            <p className="text-lg animate-pulse font-medium">Agent is deeply researching {domain}...</p>
            <p className="text-sm mt-2 text-gray-500">This is a deep web scrape and AI analysis. It typically takes 1-3 minutes.</p>
          </div>
        )}
          ...
          >
            <div className="glass-panel rounded-lg p-6 sm:p-8 relative overflow-hidden">
              <h2 className="text-xl font-bold mb-4 flex items-center gap-2 text-indigo-500">
                <Briefcase className="w-5 h-5" /> Company Overview
              </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="glass-panel rounded-lg p-6 sm:p-8 relative overflow-hidden">
                <h2 className="text-xl font-bold mb-4 flex items-center gap-2 text-orange-500">
                  <Target className="w-5 h-5" /> Expected Pain Points
                </h2>
              ...
              <div className="glass-panel rounded-lg p-6 sm:p-8 relative overflow-hidden">
                <h2 className="text-xl font-bold mb-4 flex items-center gap-2 text-emerald-500">
                  <ArrowRight className="w-5 h-5" /> Value Proposition Alignment
                </h2>
